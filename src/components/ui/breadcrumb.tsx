...
function BreadcrumbList({ className, ...props }: React.ComponentProps<"ol">) {
  return (
    <ol
      ...
      className={cn("flex flex-wrap items-center gap-1.5 text-xs text-muted-foreground sm:gap-2", className)}
      {...props}
    />
  )
}
...
function BreadcrumbPage({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span data-slot="breadcrumb-page" aria-current="page" className={cn("font-medium text-foreground", className)} {...props} />
  )
}
